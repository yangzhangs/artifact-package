...
- `review_comments`, `close_latency_h` — review engagement and processing efficiency
...
- Individual survey respondent data (names, emails) are not included; anonymized per-respondent responses, including open-ended comments, are provided in `survey/responses/`, and the ethics procedures are documented in `ETHICS.md`.
