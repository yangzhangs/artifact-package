## <mark>Use of generative artificial intelligence</mark>

<mark>Contributions clearly showing heavy use of generative AI, so-called "vibe coding", will be</mark>
dismissed out of hand.

There's nothing *inherently wrong* with using tool assistance while coding, including tools based
<mark>on generative AI. But when using AI to generate whole subroutines (or more) only based on prompts,</mark>
