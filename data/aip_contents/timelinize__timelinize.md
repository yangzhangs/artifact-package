...
- <mark>**Please disclose the use of LLMs or "AI"; we prefer hand-written, human-understood code.** We understand if you want AI assistance, but we ask that you disclose the use of AI tools. It affects our code review. Given the human-centered nature of our project, we prefer hand-crafted contributions.</mark>
