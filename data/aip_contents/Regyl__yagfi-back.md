...
* [Testing](#testing)
  ...
  * [Unit tests](#unit-tests)
    ...
    * [Example](#example)
* [AI](#ai)
  * <mark>[Why fully AI-generated PRs without understanding are not helpful](#why-fully-ai-generated-prs-without-understanding-are-not-helpful)</mark>
<!-- TOC -->
...
<mark>or a customer. Here at YAGFI, we are primarily developers who can use AI as a tool, not as</mark>
...
- <mark>**Calls out unknowns and assumptions**. It’s okay to not fully understand some bits of AI generated code. </mark>
...
## <mark>Why fully AI-generated PRs without understanding are not helpful</mark>
<mark>Today, AI tools cannot reliably make complex changes to DataFusion on their own, which is why we</mark>
...
<mark>by using AI directly, and the submitters gain little knowledge if they act only as a pass</mark>
