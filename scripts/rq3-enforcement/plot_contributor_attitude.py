#!/usr/bin/env python3
"""Horizontal bar chart for contributor attitude toward AIP - reversed order, font 13."""
...
# Don't invert - oppose at top, support at bottom
ax.invert_yaxis()

plt.subplots_adjust(left=0.20, right=0.85, top=0.97, bottom=0.17)

plt.savefig('figures/fig_contributor_attitude.pdf',
            bbox_inches='tight', dpi=300, pad_inches=0.02)
plt.savefig('figures/fig_contributor_attitude.png',
            bbox_inches='tight', dpi=300, pad_inches=0.02)
print('Saved')
