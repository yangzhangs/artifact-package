...
- <mark>Bulk AI-generated changes that clearly haven't been reviewed or tested</mark>
...
<mark>Contributions using AI tools (Copilot, Claude, ChatGPT, etc.) are welcome, but the quality bar is the same as human-written code. **If you ship it, you own it.**</mark>

<mark>We've seen a sharp increase in AI-generated PRs where the contributor clearly never ran the code, didn't test it, and can't explain what it does. These waste maintainer time and will be closed on sight.</mark>

<mark>**If you use AI to help write code, you must still:**</mark>
...
- <mark>**Scrutinize AI-generated tests.** They often pass trivially without asserting anything meaningful. Tests that don't validate real behavior will be rejected.</mark>
